...
public final class JmxTexturesExtV0 {
	...
	private static final Either<Material, String> DUMMY_TEX = Either.left(new Material(TextureAtlas.LOCATION_BLOCKS, ResourceLocation.withDefaultNamespace("block/cobblestone")));
